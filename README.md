...
Players take on the role of managing a beverage pop-up store right beneath the majestic trees at **Gardens by the Bae (Bay)**. Answer fundamental Python questions correctly to successfully serve customers, hit your sales target, and unlock a spectacular custom-coded recreation of the world-famous **Supertree Light Show**!
...
Click the green Code button on the right then download the ZIP folder and extract it. Double click on run_game.bat to play the game.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/YOUR_GITHUB_USERNAME/Supertree-Beverages.git](https://github.com/YOUR_GITHUB_USERNAME/Supertree-Beverages.git)
